					...
					<div class="setting-form">
						...
						<input type="hidden" id="role" name="role" value="Kader">
							<div class="form-wrapper">
                                <div class="input-wrap row">
									...
									<div class="col-9">
										<input id="no_kk" type="text" value="{{$biodata->no_kk}}" disabled>
									</div>
								</div>
                                <div class="input-wrap row">
									<label for="nik" class="col-3 col-form-label">NIK</label>
									<div class="col-9">
										<input id="nik" type="text" value="{{$biodata->nik}}" disabled>
									</div>
								</div>
								<div class="input-wrap row">
									<label for="alamat" class="col-3 col-form-label">RT/RW</label>
									<div class="col-9">
										<input id="alamat" type="text" value="{{$biodata->alamat}}" disabled>
									</div>
								</div>
                                <div class="input-wrap row">
									<label for="status" class="col-3 col-form-label">Status</label>
									<div class="col-9">
										<input id="status" type="text" value="{{$biodata->status}}" disabled>
									</div>
								</div>
							</div>
						</form>
                        ...
                        <!-- <div class="container"> -->
                            <div class="col-14 justify-content-center">
                                <a href="/profile/{{$biodata->id}}/edit" class="button button-outline">Edit Data Diri</a>
                            </div>
                        <!-- </div> -->
					</div>
